/* ATTENTION *
 * THIS FILE HAS TAKEN FROM THE INTERNET TO EXTEND CLASSES FROM IT FOR HW04
 *
 * DATA STRUCTURES - ABSTRACTION AND DESIGN USING JAVA BY KOFFMAN & WOLFGANG
 * IS BEING USED FOR CSE222 COURSE ON GTU. THIS IS ALSO TAKES PLACE INSIDE
 * THAT BOOK
 *
 * I DON'T OWN ANY RIGHTS AND DIDN'T IMPLEMENT ANY THING BUT getSize() METHOD
 */
