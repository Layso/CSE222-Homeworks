 ...
 * New iterator for level order iteration added differently from HW05
...
public class FamilyTree extends BinaryTree<String>
{
	...
	/**
	 * Iterator overload to traverse family tree with level order traversal
	 * instead of pre order that inherited from the BinaryTree class
